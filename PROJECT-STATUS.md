...
- [ ] ⏳ 域名解析到服务器
- [ ] ⏳ 上传代码到服务器
- [ ] ⏳ 服务器环境配置（Node.js + PM2 + Nginx）
- [ ] ⏳ 构建项目并启动
- [ ] ⏳ ICP备案（网站名称：游戏学习笔记）
- [ ] ⏳ 申请SSL证书（HTTPS）
- [ ] ⏳ 接入广告联盟（Google AdSense → 百度联盟 → 腾讯优量汇）
